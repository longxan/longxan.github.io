...
Edit.prototype = {
    ...
    updateAnalogDateTimeFormat: function (id, format) {
        ...
        //format === full-time 
        $("#" + id + " div").html("");
        $("#" + id).children("div:first").append("<div class = 'dayTime'>ddd.HH:mm:ss</div>");
        $("#" + id).children("div:first").append("<div class = 'date'>yyyy-MM-dd</div>");
        if (format === "ymd") {
            $("#" + id + " .dayTime").css("display", "none");
        } else if (format === "hms") {
